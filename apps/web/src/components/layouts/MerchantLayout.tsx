...
const NAV_ITEMS = [
  ...
  { to: '/merchant/simulate', label: 'Simulasi Pinjaman', end: false },
  { to: '/merchant/applications', label: 'Pengajuan Saya', end: false },
  { to: '/merchant/profile', label: 'Profil Usaha', end: false },
];
