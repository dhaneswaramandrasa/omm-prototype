...
const NAV_ITEMS = [
  ...
  { to: '/admin/applications', label: 'Semua Pengajuan', end: false },
  { to: '/admin/partners', label: 'Partner', end: false },
  { to: '/admin/merchants', label: 'Merchant', end: false },
  { to: '/admin/sla', label: 'SLA Monitor', end: false },
];
