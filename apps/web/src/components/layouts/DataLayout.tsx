...
const NAV_ITEMS = [
  { to: '/data', label: 'Data Intelligence', end: true },
  { to: '/data/scoring',  label: 'Scoring Engine',    end: false },
  { to: '/data/access',   label: 'Access Logs',       end: false },
  { to: '/data/reports',  label: 'Reports',           end: false },
];
